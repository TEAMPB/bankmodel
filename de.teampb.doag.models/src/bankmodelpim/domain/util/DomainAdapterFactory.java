/**
 */
package bankmodelpim.domain.util;
...
public class DomainAdapterFactory extends AdapterFactoryImpl {
	...
	protected DomainSwitch<Adapter> modelSwitch =
		new DomainSwitch<Adapter>() {
			@Override
			public Adapter caseBankAccountHolder(BankAccountHolder object) {
				return createBankAccountHolderAdapter();
			}
			@Override
			...
			@Override
			public Adapter casePIMBankObject(PIMBankObject object) {
				return createPIMBankObjectAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link bankmodelpim.domain.BankAccountHolder <em>Bank Account Holder</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link bankmodelpim.domain.BankAccount <em>Bank Account</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link bankmodelpim.domain.Bank <em>Bank</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link bankmodelpim.domain.PIMBankObject <em>PIM Bank Object</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPIMBankObjectAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link bankmodelpim.domain.AccountTransaction <em>Account Transaction</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
