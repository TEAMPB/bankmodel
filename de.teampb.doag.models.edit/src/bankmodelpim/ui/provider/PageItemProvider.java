...
/**
 * This is the item provider adapter for a {@link bankmodelpim.ui.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Page_layout_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Page_layout_feature", "_UI_Page_type"),
				 UiPackage.Literals.PAGE__LAYOUT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UiPackage.Literals.PAGE__DATAFIELD);
			childrenFeatures.add(UiPackage.Literals.PAGE__OPERATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UiPackage.Literals.PAGE__DATAFIELD,
				 UiFactory.eINSTANCE.createDataField()));

		newChildDescriptors.add
			(createChildParameter
				(UiPackage.Literals.PAGE__OPERATION,
				 UiFactory.eINSTANCE.createOperation()));
	}
